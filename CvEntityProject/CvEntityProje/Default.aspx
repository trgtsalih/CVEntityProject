...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">SALİH TURGUT</a></h1>
            <p class="top_hdp mt-2">YAZILIM MÜHENDİSİ</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
    ...
    <div class="main">
        ...
        <div class="news" id="news">
            <h3 class="w3_head mb-4 text-left">İş Deneyimlerim</h3>
            ...
            <div class="contact_grid_right mt-5 mx-auto text-left">
                <form action="#" method="post" runat="server">
                    <div class="row contact_top">
                        ...
                        <div class="col-sm-6">
                            <asp:TextBox ID="TextBox2" runat="server" placeholder="Email Adresiniz"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" TextMode="MultiLine" Height="30"> </asp:TextBox>

                   
                    <asp:Button ID="Button1" runat="server" Text="Gönder" CssClass="btn btn-info" OnClick="Button1_Click" />
                    <asp:Button ID="Button2" runat="server" Text="Vazgeç" CssClass="btn btn-warning" OnClick="Button2_Click" />
